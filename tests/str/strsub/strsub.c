...
char *
strsub_original(char *orig_begin, char *sub_begin, char *replace_begin)
{
    char *orig       = orig_begin;
    int sub_len      = 0;
    bool sub_set     = false;
    char *sub        = sub_begin;
    int replace_len  = 0;
    bool replace_set = false;
    char *replace    = replace_begin;
    int orig_len     = 0;
    bool orig_set    = false;
    ...
    for (i = 0; i < orig_len; i++) {
        ...
        if (count == sub_len) {
            if (sub_len == replace_len) {
                ...
                char *orig_temp =
                    malloc((orig_temp_len + 1) * sizeof *orig_temp);
...
char *
BOP_strsub(char *orig_begin, char *sub_begin, char *replace_begin)
{
    char *orig       = orig_begin;
    int sub_len      = 0;
    bool sub_set     = false;
...
int
find_int(int *haystack, int size, int needle)
{
    int step = 1000;
    int i, j;
