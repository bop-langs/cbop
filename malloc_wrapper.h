...
int
posix_memalign(void **, size_t alignment, size_t size);
void *
...
void *
aligned_alloc(size_t size, size_t boundary);
void *
valloc(size_t size);
struct mallinfo
mallinfo();
...
void *
sys_realloc(void *, size_t);
void
sys_free(void *);
void *sys_calloc(size_t, size_t);
size_t
sys_malloc_usable_size(void *);
int
sys_posix_memalign(void **, size_t, size_t);
#endif
